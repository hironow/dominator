...
import (
	...
	cmd "github.com/hironow/dominator/internal/cmd"
...
func TestSubcommands_Exist(t *testing.T) {
	...
	expected := []string{"init", "doctor", "clean", "archive-prune", "version", "update"}
...
func TestRootCommand_VersionFlag(t *testing.T) {
	...
	output := buf.String()
	if !strings.Contains(output, "dominator version") {
		t.Errorf("--version output should contain 'dominator version', got %q", output)
	}
}
...
func TestVersionCommand_Output(t *testing.T) {
	...
	output := buf.String()
	if !strings.Contains(output, "dominator") {
		t.Error("version output should contain 'dominator'")
	}
