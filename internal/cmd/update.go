...
func newUpdateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "update",
		Short: "Self-update dominator to the latest release",
		Long: `Self-update dominator to the latest GitHub release.
...
installing.`,
  ...
  dominator update`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			latest, found, err := updater.DetectLatest(cmd.Context(), selfupdate.ParseSlug("hironow/dominator"))
			if err != nil {
