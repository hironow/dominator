...
func OtelEnvContent(backend, entity, project string) (string, error) { // nosemgrep: domain-primitives.multiple-string-params-go -- backend/entity/project are semantically distinct OTel configuration axes; all are opaque IDs not interchangeable [permanent]
	switch backend {
	case "jaeger":
